        ...
        <main class="p-8 max-w-7xl mx-auto flex-1 w-full">
            ...
            <div class="result-frame p-6 rounded-xl shadow-2xl flex" 
                ...
                <div class="w-1/3 pl-6 flex flex-col justify-between">
                    ...
                    <div>
                        <h3 class="text-2xl font-extrabold mb-4" style="color: var(--color-heading);">Per-Lesson performance</h3>
                        <div class="space-y-4">
                    ...
                    <div class="pt-6 space-y-3">
                        ...
                        <a href="assessmentTopic.php" class="w-full py-2 rounded-full transition interactive-button retry-button flex items-center justify-center font-semibold text-sm">
