...
<head>
    ...
    <title>Guided Learning Module Preview | ISU Training Platform</title>
            ...
            <div class="status-bar flex flex-col md:flex-row md:justify-between md:items-center">
                <div class="flex items-center">
                    <h2 class="text-2xl font-bold" style="color: var(--color-text);">
                        <i class="fas fa-chalkboard-teacher mr-2" style="color: var(--color-heading);"></i> Foundational Knowledge Module
                    </h2>
                </div>
                <div class="mt-3 md:mt-0">
                    <span class="recommended-badge">
                        <i class="fas fa-star mr-2"></i> Recommended for Beginners
                    </span>
                </div>
            </div>
            ...
            <div class="core-content">
                ...
                <div class="left-pane">
                    ...
                    <p class="text-sm mb-6" style="color: var(--color-text-secondary);">
                        Build foundational knowledge with guided learning, step-by-step explanations, and unlimited practice opportunities to solidify core concepts.
                    </p>
                    ...
                    <div class="info-block space-y-4" style="background-color: var(--color-card-section-bg);">
                        ...
                        <div class="checklist-item">
                            <i class="fas fa-check-circle text-lg" style="color: var(--color-correct);"></i>
                            <div>
                                <h5 class="font-medium" style="color: var(--color-text);">Step-by-step Guided Learning</h5>
                                <p class="text-xs" style="color: var(--color-text-secondary);">Structured progression through topics.</p>
                            </div>
                        </div>
                        <div class="checklist-item">
                            <i class="fas fa-check-circle text-lg" style="color: var(--color-correct);"></i>
                            <div>
                                <h5 class="font-medium" style="color: var(--color-text);">Unlimited Practice Attempts</h5>
                                <p class="text-xs" style="color: var(--color-text-secondary);">Repetition for mastery without penalty.</p>
                            </div>
                        </div>
                        <div class="checklist-item">
                            <i class="fas fa-check-circle text-lg" style="color: var(--color-correct);"></i>
                            <div>
                                <h5 class="font-medium" style="color: var(--color-text);">Detailed Explanations & Hints</h5>
                                <p class="text-xs" style="color: var(--color-text-secondary);">In-depth contextual support when needed.</p>
                            </div>
                        </div>
                        <div class="checklist-item">
                            <i class="fas fa-check-circle text-lg" style="color: var(--color-correct);"></i>
                            <div>
                                <h5 class="font-medium" style="color: var(--color-text);">Progress Tracking & Analytics</h5>
                                <p class="text-xs" style="color: var(--color-text-secondary);">Monitor skill development over time.</p>
                            </div>
                        </div>
                    </div>
                </div>
                ...
                <div class="right-pane">
                    ...
                    <div class="bg-[var(--color-card-bg)] p-4 rounded-lg space-y-3 border border-gray-200">
                        ...
                        <div class="flex justify-between text-sm">
                            <span style="color: var(--color-text-secondary);">Learning Pace:</span>
                            <span class="font-bold" style="color: var(--color-heading-secondary);">Self-Directed</span>
                        </div>
                        <div class="flex justify-between text-sm">
                            <span style="color: var(--color-text-secondary);">Estimated Completion:</span>
                            <span class="font-medium" style="color: var(--color-text);">3 Hours</span>
                        </div>
                    </div>
                    ...
                    <div class="mt-6 p-4 rounded-lg" style="background-color: var(--color-button-secondary); color: var(--color-button-secondary-text);">
                        <p class="text-sm font-semibold flex items-center">
                            <i class="fas fa-chart-line mr-2"></i> Current Progress: 40% Complete
                        </p>
                        <p class="text-xs mt-1">
                            Your last session was automatically saved. You may resume now.
                        </p>
                    </div>
            ...
            <div class="card-footer">
                <div class="flex justify-end gap-4">
                    <button id="back-btn" class="btn-base btn-secondary">
                        <i class="fas fa-door-open mr-2"></i> Return to Dashboard
                    </button>
                    <button id="start-training-btn" class="btn-base btn-primary">
                        <i class="fas fa-play-circle mr-2"></i> RESUME/START MODULE
                    </button>
                </div>
    ...
    <div id="confirmation-modal" class="modal-overlay" role="dialog" aria-modal="true" aria-labelledby="modal-title">
        <div class="modal-content">
            <div class="modal-header">
                <i class="fas fa-pause-circle text-xl mr-3" style="color: var(--color-heading-secondary);"></i>
                <h3 id="modal-title" class="font-bold">Suspend Training Session?</h3>
            </div>
            <div class="modal-body">
                <p id="modal-message">Exiting will automatically save your progress and return you to the dashboard. You can resume from the last checkpoint.</p>
            </div>
            <div class="modal-footer flex justify-end gap-3">
                <button id="modal-cancel-btn" class="btn-base btn-secondary text-sm py-2 px-5">
                    Cancel (Continue)
                </button>
                <a href="course_assessment_mode.php" id="modal-confirm-btn" class="btn-base text-sm py-2 px-5" style="background-color: var(--color-heading-secondary); color: white;">
                    Confirm Exit
                </a>
            </div>
        </div>
    ...
    <script>
        ...
        document.addEventListener('DOMContentLoaded', function() {
            ...
            backBtn.addEventListener('click', function() {
                showModal(
                    'Suspend Training Session?',
                    'Exiting will automatically save your progress and return you to the dashboard. You can resume from the last checkpoint.'
                );
            });
