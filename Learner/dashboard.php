...
<body class="min-h-screen flex dark-mode" style="background-color: var(--color-main-bg); color: var(--color-text);">
    ...
    <div class="flex-1 flex flex-col ml-0 md:ml-16">
       <header style="background-color: var(--color-header-bg); border-bottom: 2px solid var(--color-heading-secondary);" class="main-header sticky top-0 z-50 backdrop-blur-sm p-4 shadow-lg px-4 md:px-6 py-3 flex justify-between items-center fade-slide">
    <div class="flex gap-4">
        <button style="background-color: var(--color-card-bg); color: var(--color-text);" class="mobile-menu-button md:hidden rounded-lg p-2">
            <i class="fas fa-bars text-lg"></i>
        </button>
        <div class="flex flex-col">
            <h1 style="color: var(--color-heading);" class="text-lg md:text-2xl font-bold">
                <?php echo "Welcome Back, " . $user_full_name ?>
            </h1>
            <h6 style="color: var(--color-text-secondary);" class="text-xs font-bold">
                <?php echo  "Continue your journey!"?>
            </h6>
        </div>
    </div>
    <div class="flex items-center space-x-3">
        <a href="profile.php" style="background-color: var(--color-user-bg); color: var(--color-user-text); border: 2px solid var(--color-icon);" class="flex items-center space-x-2 px-3 md:px-4 py-2 rounded-full transition shadow-md">
            <i style="color: var(--color-heading);" class="fas fa-user-circle text-xl md:text-2xl"></i>
            <span style="color: var(--color-user-text);" class="font-bold text-sm md:text-base"><?php echo htmlspecialchars($first_name_only); ?></span>
            <span style="background-color: var(--color-xp-bg); color: var(--color-xp-text);" class="px-2 py-0.5 rounded-full text-xs font-extrabold">LV <?php echo $user_level; ?></span>
        </a>
    </div>
</header>
