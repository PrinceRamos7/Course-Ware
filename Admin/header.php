...
<header class="header-bg shadow-lg p-4 flex justify-between items-center sticky top-0 z-10" style="background-color:white">
    ...
    <button class="flex items-center space-x-2 px-3 py-2 text-sm rounded-md shadow bg-gray-100 hover:bg-gray-200 transition hover-scale text-[var(--color-text)]" onclick="window.location.href='../Admin/profile.php'">    
