    ...
    <div class="flex-1 flex flex-col">
        <header class="main-header backdrop-blur-sm p-4 shadow-lg px-6 py-3 flex justify-between items-center sticky top-0 z-10" 
            ...
            <div class="flex flex-col">
                ...
                <h6 class="text-xs font-bold" style="color: var(--color-text-secondary);">Introduction to Python > Variables & Data Types</h6>
            </div>
            <a href="topicContent.php" class="secondary-action-button px-4 py-2 rounded-full transition-all text-sm font-semibold">
        ...
        <main class="p-8 flex-1 flex flex-col items-center justify-center">
            ...
            <div class="assessment-frame p-10 rounded-2xl w-full max-w-2xl text-center space-y-8" 
                ...
                <h2 class="text-4xl font-extrabold" style="color: var(--color-heading);">Variables & Data Types: Final Test</h2>
                
                <p class="text-lg font-medium" style="color: var(--color-text);">
                    Prepare to demonstrate your mastery! This assessment covers **declaration, scope, and conversion** of variables.
                </p>
                ...
                <div class="grid grid-cols-3 gap-4">
                    ...
                    <div class="p-4 rounded-xl stat-grid-item">
                        ...
                        <p class="text-2xl font-extrabold status-completed">+300</p>
                    </div>
                </div>
                ...
                <div class="w-full text-center pt-4">
                    <a href="topicCard.php" class="secondary-action-button inline-flex items-center justify-center px-6 py-2 rounded-full transition text-sm">
